    ...
    class BLEPrinter {
        ...
        async write(data) {
            if (!this.characteristic) {
             ...
             // Data chunking to prevent buffer overflow on mobile devices
            const CHUNK_SIZE = 20; // A safe, common MTU size for BLE
            const DELAY = 50; // Delay in milliseconds between chunks to allow printer buffer to process
