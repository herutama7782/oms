(function (global, factory) {
    ...
    class BLEPrinter {
        ...
        async write(data) {
            ...
            const CHUNK_SIZE = 256; // Increased chunk size for better performance with binary data.
            const DELAY = 50; // Delay in milliseconds between chunks to allow the printer's buffer to process.
