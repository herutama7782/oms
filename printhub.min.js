(function (global, factory) {
    ...
    class BLEPrinter {
        ...
        async write(data) {
            ...
            const CHUNK_SIZE = 64; // Increased chunk size for better performance with binary data.
            const DELAY = 75; // Delay in milliseconds between chunks to allow the printer's buffer to process.
