(function (global, factory) {
  ...
  // ========================================================
  // FITUR BARU: Helper untuk format Rupiah
  // ========================================================
  /**
  ...
  const formatRupiah = (value) => {
    ...
    // Gunakan locale 'id-ID' untuk format pemisah ribuan yang benar (titik)
  ...
  const PRINTER_SERVICE_CANDIDATES = [
    ...
    '0000180a-0000-1000-8000-00805f9b34fb', '49535343-fe7d-4ae5-8fa9-9fafd205e455',
  ];
  ...
  class Printer {
    ...
    // ========================================================
    // FITUR BARU: Metode untuk mencetak dua kolom dengan format Rupiah
    // ========================================================
    /**
     * Mencetak teks dalam dua kolom, di mana kolom kedua adalah nilai uang yang diformat ke Rupiah.
     * @param {string} text1 - Teks untuk kolom kiri.
     * @param {number|string} value2 - Nilai numerik untuk kolom kanan.
     * @param {object} options - Opsi pemformatan teks (align, bold, dll).
     */
    async writeTextWith2ColumnRupiah(text1, value2, options = {}) {
      const formattedValue = formatRupiah(value2);
      await this.writeTextWith2Column(text1, formattedValue, options);
    }
    ...
    async printImage(imageUrl, options = {}) {
      ...
      const { align = 'center', maxWidth = defaultMaxWidth, threshold = 128, stripeHeight = 16 } = options;
