...
async function generateLabelEscPos() {
    ...
    if (barcodeCode) {
        ...
        // Print barcode text below, also centered, using smaller Font B
        encoder.font('b');
        const barcodeTextLines = wrapWords(barcodeCode, paperWidthCharsFontB).map(l => l.trim());
